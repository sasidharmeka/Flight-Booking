...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-flight-proj")
    ...
    route_summarization_table = tables["route_summarization_table"]
    sales_summarization_table = tables["sales_summarization_table"]
    ...
    file_sensor = GCSObjectExistenceSensor(
        ...
        bucket=gcs_bucket,
        object=f"{gcs_bucket}/source-{env}/flight_booking.csv",  # Full file path in GCS
    ...
    batch_details = {
        "pyspark_batch": {
            ...
            "args": [
                ...
                f"--route_summarization_table={route_summarization_table}", 
                f"--sales_summarization_table={sales_summarization_table}" # If needed
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "406744450075-compute@developer.gserviceaccount.com",
                "network_uri": "projects/authentic-codex-475613-p1/global/networks/default",
                "subnetwork_uri": "projects/authentic-codex-475613-p1/regions/us-central1/subnetworks/default",
            }
        },
    }
    ...
    pyspark_task = DataprocCreateBatchOperator(
        ...
        batch=batch_details,
        batch_id=batch_id,
        project_id="authentic-codex-475613-p1",
        region="us-central1",
